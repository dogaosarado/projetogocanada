    ...
    with ui.column().classes("w-full min-h-screen bg-stone-50"):
        ...
        with ui.column().classes("w-full items-center py-16 px-4 bg-white"):
            with ui.column().classes("max-w-3xl gap-4"):
                ...
                # TODO: texto real
                ui.label(
                    "[TODO: parágrafo explicando o formato da mentoria — quem conduz, "
                    "como funcionam os encontros, o que o cliente leva de cada etapa.]"
        ...
        with ui.column().classes("w-full items-center py-16 px-4"):
            with ui.column().classes("max-w-3xl gap-4"):
                ...
                ui.html(
                    ...
                    "<li>[TODO: perfil de candidato 1]</li>"
                    "<li>[TODO: perfil de candidato 2]</li>"
                    "<li>[TODO: perfil de candidato 3]</li>"
                    "</ul>"
                )
        ...
        with ui.column().classes("w-full items-center py-16 px-4 bg-white"):
            with ui.column().classes("max-w-3xl gap-4"):
                ...
                ui.html(
                    ...
                    "<li>[TODO: etapa 1 — ex. diagnóstico inicial]</li>"
                    "<li>[TODO: etapa 2 — ex. definição de universidades-alvo]</li>"
                    "<li>[TODO: etapa 3 — ex. preparação de dossiê/SOP]</li>"
                    "<li>[TODO: etapa 4 — ex. simulações e revisão final]</li>"
                    "</ol>"
                )
